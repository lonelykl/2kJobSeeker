...
<li class="active"><?php echo '<a href="work.php'.$sessionInfoCond.'">';?>Donation</a></li>
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<div class="page-title-donation" style="width: 300px;height: 297px;margin: 0 auto;">
							</div>
						</div>
					</div>
				</div>
...
<ul style="text-align:  left;">
    ...
    <li>Quantum Pledged (one time payment)
    </li>
    <li>Monthly Payment
    </li>
    <li>Date to be Delivered
    </li>
</ul>
