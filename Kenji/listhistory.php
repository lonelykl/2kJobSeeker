...
<form action="juclistjob.php<?php echo $sessionInfoCond ?>" method="post" target="iframe1">
							
							<input type="text" name="txtFilter" id="txtFilter" class="form-control" placeholder="Enter Keyword for List">
							<br>
